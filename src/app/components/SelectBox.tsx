...
interface SelectBoxProps {
  value: string;
  onChange: (event: React.MouseEvent<HTMLSpanElement>, value: string) => void;
  onAppear: () => void;
  className: string;
...
export default function SelectBox({
  ...
  return (
    <div className="relative content-center">
      <span
        className={twMerge('flex gap-4 sm:gap-5', className)}
        onClick={onAppear}>
        {value} <Image src={iconArrowDown} alt="" width={12} height={6} />
      </span>
      <div
        ref={selectMenuRef}
